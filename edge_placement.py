...
def	edges_placement(cube, bad_edges, good_edges_up, good_edges_down, lst_moves):
        ...
        i = 0
        lst_order_edges[0] = utils.replace_tpu(lst_order_edges[0], "U")
        #lst_order_edges bien replace, besoin de mettre a jour lst_order_values
        #recuperer a quelle position on doit placer l'edge suivante et la value que il doit y avoir a cet endroit la pour que ca soit dans l'ordre
