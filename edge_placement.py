...
def	edges_placement(cube, bad_edges, good_edges_up, good_edges_down, lst_moves):
        ...
        lst_order_edges[0], lst_order_values = utils.replace_tpu(lst_order_edges[0], "U") #update lst_order_values
        ...
        for edge in bad_edges:
            new_pos = edge
            bad_edges_values.append(cube.cube[new_pos[0]][new_pos[1]][new_pos[2]])
        ...
        cube, lst_order_edges[1], lst_order_values[1] = utils.find_and_move_next_edge_placement(cube, lst_order_edges[0], lst_order_values[0],\
                bad_edges, bad_edges_values, 1, next_pos, "U")
